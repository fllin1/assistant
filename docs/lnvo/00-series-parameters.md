...
detection. Transform also automatically detects bare numeric markers such as
`5.1` and OCR-glued markers such as `mp4directs.com6.2` when the marker base
matches a preceding numbered chapter heading, emitting `chapter_XX_N` ids.
